...
% ***** advisor's name
%
\def\advisorName{Dr. Thomas H. Austin}
...
%
\def\secondCommitteeMember{Dr. Ronald Mak}
...
% ***** title
%
\title{Adding Syntax Parameters to the Sweet.JS Macro Library for JavaScript}
